/**
 * Created by v-yanba on 3/21/2016.
 */
//创建svg
...
d3.json("china.geo.json", function(json) {
    svg.selectAll("path")
        ...
        //})
        //.each(function(data){
        //    d3.select(this).attr('fill', 'rgba('+~~(-0.83*data.properties.cp[0]+309)+','+~~(-0.42*data.properties.cp[0]+177)+',255,1)');
        //})
